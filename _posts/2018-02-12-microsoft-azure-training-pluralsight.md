...
<p><img class="wp-image-699 size-full" src="{{ site.baseurl }}/assets/images/20180212/Azure-training-pluralsight.png" alt="Azure training pluralsight" width="571" height="695" /> <!--Azure subscription linked to Pluralsight--></p>
<h2>What is Azure?</h2>
...
<p><img class="size-large wp-image-709" src="{{ site.baseurl }}/assets/images/20180212/Azure-Course-List-1024x637.png" alt="Azure Course List" width="780" height="485" /> <!--Azure Course List--></p>
<p>Click the "Register and start for Free" button to link your Azure and Pluralsight accounts.</p>
<p><img class="size-large wp-image-710" src="{{ site.baseurl }}/assets/images/20180212/Register-to-link-Azure-and-Pluralsight-accounts-1024x487.png" alt="Register to link Azure and Pluralsight accounts" width="780" height="371" /> <!--Register to link Azure and Pluralsight accounts--></p>
...
<p><img class="size-large wp-image-711" src="{{ site.baseurl }}/assets/images/20180212/Register-Pluralsight-form-1024x487.png" alt="Register Pluralsight form" width="780" height="371" /> <!--Register Pluralsight form--></p>
<p>Select one of the courses.</p>
<p><img class="size-large wp-image-712" src="{{ site.baseurl }}/assets/images/20180212/Azure-Pluralsight-Course-List-1024x715.png" alt="Azure Pluralsight Course List" width="780" height="545" /> <!--Azure Pluralsight Course List--></p>
<p>Start learning!</p>
<p><img class="size-large wp-image-713" src="{{ site.baseurl }}/assets/images/20180212/Start-Azure-Pluralsight-course-1024x667.png" alt="Start Azure Pluralsight course" width="780" height="508" /> <!--Start Azure Pluralsight course--></p>
